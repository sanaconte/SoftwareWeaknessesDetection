...
public class SamateDataset implements IDataSet {
    ...
    private List<String> NPD_PROJECT_LIST =

            List.of("55005-v1.0.0", "55006-v1.0.0", "55007-v1.0.0", "55008-v1.0.0", "55009-v1.0.0", "55010-v1.0.0", "55011-v1.0.0",
    ...
    public SamateDataset(String vulType) {
        ...
        if(vulType.equals("NPD")){
            ...
            projectList = NPD_PROJECT_LIST;
        }
        else if(vulType.equals("CI")){
            samateProjectDirectory = "E:/TFM/SAMATE-DATA-CI/";
            projectList = CI_PROJECT_LIST;
        }
        else{
