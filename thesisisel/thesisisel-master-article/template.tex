...
\chapterfile{introductionChapter}
%\chapterfile{backgroundChapter}
%\chapterfile{RelatedWorkChapter}
\chapterfile{BackgroundRelatedWork}
\chapterfile{ArchitectureChapter}
%\chapterfile{WorkPlan}
\chapterfile{ImplementationChapter}
\chapterfile{EvaluationChapter}
%\chapterfile{DiscussionChapter}
\chapterfile{ConclusionChapter}
